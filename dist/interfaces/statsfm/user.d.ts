...
export declare enum OrderBySetting {
    /**
...
export interface UserPublic {
    ...
    quarantined: boolean;
    appleMusicAuth: Pick<UserAppleMusicAuth, 'sync' | 'imported' | 'availableYears' | 'disabled'> | null;
    spotifyAuth: Pick<UserSpotifyAuth, 'displayName' | 'platformUserId' | 'image' | 'product' | 'sync' | 'imported' | 'disabled'> | null;
}
